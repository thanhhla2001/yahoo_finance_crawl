...
| Save output as CSV                     | python yahoo_crawler.py --tickers AAPL --period 1y --output stock_data.csv                                        |
| Save output as JSON                    | python yahoo_crawler.py --tickers AAPL --period 1y --output data.json --format json                               |
